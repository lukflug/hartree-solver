...
public class Main {
	public static void main (String args[]) {
		Atom atom=new Atom(.005,52,24,25);
		...
		atom.addElectron(1200,3,0);
		atom.addElectron(1200,3,1);
		atom.addElectron(1200,3,1);
		atom.addElectron(1200,3,1);
		atom.addElectron(1200,3,1);
		atom.addElectron(1200,3,1);
		atom.addElectron(1200,3,1);
		atom.addElectron(1200,4,0);
		atom.addElectron(1200,3,2);
		atom.addElectron(1200,3,2);
		atom.addElectron(1200,3,2);
		atom.addElectron(800,3,2);
		atom.addElectron(800,3,2);
		Screen screen=new Screen("Hartree Solver",atom);
		while (true) {
			String s=atom.updateElectrons(.1,screen);
			screen.repaint();
			if (s!=null) {
